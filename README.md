...
# Warning: This repository contains a large amount of unreviewed AI-generated code and documentation, which may cause psychological discomfort to unprepared readers.
## What is here

- `eskin_project/`: ESP32-S3 firmware for a 16x16 pressure-sensing MIDI instrument.
- `sample_project/`: Firmware for testing the performance of the model's end-side deployment for note continuation on the esp32p4
- `midi_gen_ai_rewrite/`: Training script for the continuation model generated by GPT
## Main firmware flow
